...
copied=0
for name in phone-unsigned phone-empty phone-thread phone-stream phone-photo phone-down phone-settings phone-emoji phone-attach phone-draft auto-empty auto-thread; do
