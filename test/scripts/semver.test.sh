#!/usr/bin/env bash
# Mirrors gantry-pendant/test/scripts/semver.test.ts and ai-gantry cmd/release tests.
set -euo pipefail
...
# VERSION file is the fallback current tag when git has none (release.sh).
